...
function App() {
  ...
  const bairrosRio = "Marechal Hermes, Bento Ribeiro e Mesquita ";
  const bairrosCuritiba =
    "Centro, Água Verde, Portão, Bairro Alto, Cajuru , Capão Raso e Santa Felicidade";
  const bairrosFloripa =
    "Centro, Campinas, Kobrasol, Estreito, Santa Mônica e Canasvieiras";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <a href="https://neoscan.com.br">
            <img src="./assets/img/home.png" alt="" width={25} />
          </a>
        </header>
        ...
        >
          ...
          >
            <img
              src="./assets/img/map-icon.png"
              alt=""
              width={50}
              height={50}
            />
            <img
              src={`./assets/img/${cidade}.png`}
              alt=""
              width={150}
              style={{
                position: "absolute",
      ...
      >
        <p id="creditos">Desenvolvido por LucianoNeo - 2022</p>
      </div>
    </>
  );
}
